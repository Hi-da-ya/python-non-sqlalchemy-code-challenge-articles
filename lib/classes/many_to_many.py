class Article:
    ...
    #setting article title property
    @property
    def title(self):
        return self.__title 
...
class Author:
    ...
    def magazines(self):
        magazine = set()
        #iterate through author's articles and add them to the magazines he has contributed to
